...
Weaviate provides a comprehensive security framework designed to protect your vector search data. Our approach focuses on:
- Robust authentication mechanisms
- Granular access control
- Secure token management
- Compliance with industry standards

Choose the right configuration to match your security requirements.
...
export const configOpsData = [
  ...
  {
  {
    ...
    description: 'Secure your Weaviate instance with robust authentication methods, including OIDC, API keys, and fine-grained access control.',
    link: '/weaviate/configuration/authz-authn',
    icon: 'fas fa-key',
  },
  {
    title: 'RBAC',
    description: 'Implement Role-Based Access Control with customizable roles, granular permissions, and secure token management strategies.',
