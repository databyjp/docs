...
With the introduction of dynamic resharding, you can now redistribute data across nodes without downtime. This feature allows you to:
- Adjust the number of shards in an existing cluster
- Optimize data distribution dynamically
- Maintain performance during scaling operations

:::tip
Use the new resharding feature to fine-tune your cluster's data distribution as your workload evolves.
:::
